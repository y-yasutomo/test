...
# -------------------------------------------------------------------------
geom_line(data=Data2,aes(x=YR_MONTH, y=NON_MEMBER_SUM_SALES_AMOUNT,group=STORENAME,
                         col=STORENAME),linetype=1,size=1.2) +
  geom_point(data=Data2,aes(x=YR_MONTH, y=NON_MEMBER_SUM_SALES_AMOUNT,group=STORENAME,
                            col=STORENAME),size=2) +
